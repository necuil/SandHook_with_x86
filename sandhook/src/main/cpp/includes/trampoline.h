...
#if defined(__i386__)
#define SIZE_REPLACEMENT_HOOK_TRAMPOLINE 32
#define OFFSET_REPLACEMENT_ART_METHOD 24
#define OFFSET_REPLACEMENT_OFFSET_CODE_ENTRY 28

#define SIZE_DIRECT_JUMP_TRAMPOLINE 5
#define OFFSET_JUMP_ADDR_TARGET 1

#define SIZE_INLINE_HOOK_TRAMPOLINE 100
#define OFFSET_INLINE_ORIGIN_CODE 36
#define OFFSET_INLINE_ORIGIN_ART_METHOD 84
#define OFFSET_INLINE_ADDR_ORIGIN_CODE_AFTER_HOOK 88
#define OFFSET_INLINE_HOOK_ART_METHOD 92
#define OFFSET_INLINE_ADDR_HOOK_CODE_ENTRY 96

#define SIZE_CALL_ORIGIN_TRAMPOLINE 24
#define OFFSET_CALL_ORIGIN_ART_METHOD 16
#define OFFSET_CALL_ORIGIN_JUMP_ADDR 20

#define SIZE_ORIGIN_PLACE_HOLDER 30
#elif defined(__x86_64__)
#error "no support fo x86_64!"
