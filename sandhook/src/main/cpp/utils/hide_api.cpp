...
extern "C" {
    ...
    void* hook_native(void* origin, void *replace) {
        void* backup = nullptr;
        MSHookFunction(origin, replace, &backup);
        return backup;
    }
    ...
    bool hookClassInit(void(*callback)(void*)) {
        if (SDK_INT >= ANDROID_R) {
            ...
            backup_mark_class_initialized = reinterpret_cast<void *(*)(void *, void *, uint32_t*)>(hook_native(symMarkClassInitialized, (void *) replaceMarkClassInitialized));

            backup_update_methods_code = reinterpret_cast<void (*)(void *, ArtMethod *, const void*)>(hook_native(symUpdateMethodsCode, (void *) replaceUpdateMethodsCode));
            ...
            if (symFixupStaticTrampolines == nullptr)
                return false;
            backup_fixup_static_trampolines = reinterpret_cast<void (*)(void *, void *)>(hook_native(symFixupStaticTrampolines, (void *) replaceFixupStaticTrampolines));
